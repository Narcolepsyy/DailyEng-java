...
class StudyPlanServiceTest {
    ...
    class ToggleTaskCompletion {
        ...
        void toggle() {
            var task = createTestTask(TASK_ID, TaskType.vocab, "Learn Words", false);
            when(studyTaskRepository.findByIdAndPlan_UserId(TASK_ID, USER_ID)).thenReturn(Optional.of(task));
        ...
        void notFound() {
            when(studyTaskRepository.findByIdAndPlan_UserId(TASK_ID, USER_ID)).thenReturn(Optional.empty());
