    ...
    return (
        <Dialog open={open} onOpenChange={(val) => {
            ...
            <DialogTrigger asChild>
                {children ? children : (
                    <Button variant="ghost" size="icon" aria-label={saved ? "Added to Notebook" : "Add to Notebook"} className={saved ? "text-primary-600" : "text-slate-400 hover:text-primary-600"} title="Add to Notebook">
